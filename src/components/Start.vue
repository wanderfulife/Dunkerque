  ...
  <div class="app-container">
    ...
    <div class="content-container">
      ...
      <div v-else-if="currentStep === 'start'" class="start-survey-container">
        <h2>
          Bonjour,<br />
          pour mieux connaître les usagers de la gare de Dunkerque, la SNCF
...
const selectAnswer = (option) => {
  if (currentQuestion.value) {
    ...
    if ((questionId === "QP4" || questionId === "QNV3") && option.id === 1) {
      answers.value[`${questionId}__COMMUNE`] = "DUNKERQUE"; // Note the double underscore
      answers.value[`${questionId}__CODE_INSEE`] = "59183"; // Note the double underscore
...
const getNextId = async () => {
  ...
  return `Dunkerque-${counter.toString().padStart(6, "0")}`;
};
</script>
