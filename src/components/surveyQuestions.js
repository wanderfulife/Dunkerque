export const questions = [
	...
	{ 
		...
		options: [
			{ id: 1, text: "Calais Ville", next: "QP2" },
			{ id: 2, text: "Calais Les Fontinettes", next: "QP2" },
			{ id: 3, text: "Beau-Marais", next: "QP2" },
			{ id: 4, text: "Gravelines", next: "QP2" },
			{ id: 5, text: "Bourbourg", next: "QP2" },
			{ id: 6, text: "Grande-Synthe", next: "QP2" },
			{ id: 7, text: "Coudekerque-Branche", next: "QP2" },
			{ id: 8, text: "Bergues", next: "QP2" },
			{ id: 9, text: "Esquelbecq", next: "QP2" },
			{ id: 10, text: "Arneke (Hazebrouck)", next: "QP2" },
			{ id: 11, text: "Cassel (Hazebrouck)", next: "QP2" },
			{ id: 12, text: "Hazebrouck", next: "QP2" },
			{ id: 13, text: "Strazeele", next: "QP2" },
			{ id: 14, text: "Bailleul", next: "QP2" },
			{ id: 15, text: "Steenwerck", next: "QP2" },
			{ id: 16, text: "Nieppes", next: "QP2" },
			{ id: 17, text: "Armentieres", next: "QP2" },
			{ id: 18, text: "Perenchies", next: "QP2" },
			{ id: 19, text: "Lille Flandres", next: "QP2" },
			{ id: 20, text: "Lille Europe", next: "QP2" },
			{ id: 21, text: "Berguette-Isbergues", next: "QP2" },
			{ id: 22, text: "Lillers (Fouque)", next: "QP2" },
			{ id: 23, text: "Bethune", next: "QP2" },
			{ id: 24, text: "Noeux-les-Mines", next: "QP2" },
			{ id: 25, text: "Bully-Grenay", next: "QP2" },
			{ id: 26, text: "Lens", next: "QP2" },
			{ id: 27, text: "Avion (Lens)", next: "QP2" },
			{ id: 28, text: "Arras", next: "QP2" },
			{ id: 29, text: "Amiens", next: "QP2" },
			{ id: 30, text: "Paris Nord", next: "QP2" },
			{ id: 99, text: "Autre", next: "QP1_A" }
		]
	},
	{
		id: "QP1_A",
	...
	},
	{
		...
		options: [
			{ id: 1, text: "Calais Ville", next: "QC2" },
			{ id: 2, text: "Calais Les Fontinettes", next: "QC2" },
			{ id: 3, text: "Beau-Marais", next: "QC2" },
			{ id: 4, text: "Gravelines", next: "QC2" },
			{ id: 5, text: "Bourbourg", next: "QC2" },
			{ id: 6, text: "Grande-Synthe", next: "QC2" },
			{ id: 7, text: "Coudekerque-Branche", next: "QC2" },
			{ id: 8, text: "Bergues", next: "QC2" },
			{ id: 9, text: "Esquelbecq", next: "QC2" },
			{ id: 10, text: "Arneke (Hazebrouck)", next: "QC2" },
			{ id: 11, text: "Cassel (Hazebrouck)", next: "QC2" },
			{ id: 12, text: "Hazebrouck", next: "QC2" },
			{ id: 13, text: "Strazeele", next: "QC2" },
			{ id: 14, text: "Bailleul", next: "QC2" },
			{ id: 15, text: "Steenwerck", next: "QC2" },
			{ id: 16, text: "Nieppes", next: "QC2" },
			{ id: 17, text: "Armentieres", next: "QC2" },
			{ id: 18, text: "Perenchies", next: "QC2" },
			{ id: 19, text: "Lille Flandres", next: "QC2" },
			{ id: 20, text: "Lille Europe", next: "QC2" },
			{ id: 21, text: "Berguette-Isbergues", next: "QC2" },
			{ id: 22, text: "Lillers (Fouque)", next: "QC2" },
			{ id: 23, text: "Bethune", next: "QC2" },
			{ id: 24, text: "Noeux-les-Mines", next: "QC2" },
			{ id: 25, text: "Bully-Grenay", next: "QC2" },
			{ id: 26, text: "Lens", next: "QC2" },
			{ id: 27, text: "Avion (Lens)", next: "QC2" },
			{ id: 28, text: "Arras", next: "QC2" },
			{ id: 29, text: "Amiens", next: "QC2" },
			{ id: 30, text: "Paris Nord", next: "QC2" },
			{ id: 99, text: "Autre", next: "QC1_A" }
		]
	},
	{
		id: "QC1_A",
	...
	},
	{
		...
		text: "Quelle sera votre gare de destination ?",
		options: [
			{ id: 1, text: "Calais Ville", next: "QCo2" },
			{ id: 2, text: "Calais Les Fontinettes", next: "QCo2" },
			{ id: 3, text: "Beau-Marais", next: "QCo2" },
			{ id: 4, text: "Gravelines", next: "QCo2" },
			{ id: 5, text: "Bourbourg", next: "QCo2" },
			{ id: 6, text: "Grande-Synthe", next: "QCo2" },
			{ id: 7, text: "Coudekerque-Branche", next: "QCo2" },
			{ id: 8, text: "Bergues", next: "QCo2" },
			{ id: 9, text: "Esquelbecq", next: "QCo2" },
			{ id: 10, text: "Arneke (Hazebrouck)", next: "QCo2" },
			{ id: 11, text: "Cassel (Hazebrouck)", next: "QCo2" },
			{ id: 12, text: "Hazebrouck", next: "QCo2" },
			{ id: 13, text: "Strazeele", next: "QCo2" },
			{ id: 14, text: "Bailleul", next: "QCo2" },
			{ id: 15, text: "Steenwerck", next: "QCo2" },
			{ id: 16, text: "Nieppes", next: "QCo2" },
			{ id: 17, text: "Armentieres", next: "QCo2" },
			{ id: 18, text: "Perenchies", next: "QCo2" },
			{ id: 19, text: "Lille Flandres", next: "QCo2" },
			{ id: 20, text: "Lille Europe", next: "QCo2" },
			{ id: 21, text: "Berguette-Isbergues", next: "QCo2" },
			{ id: 22, text: "Lillers (Fouque)", next: "QCo2" },
			{ id: 23, text: "Bethune", next: "QCo2" },
			{ id: 24, text: "Noeux-les-Mines", next: "QCo2" },
			{ id: 25, text: "Bully-Grenay", next: "QCo2" },
			{ id: 26, text: "Lens", next: "QCo2" },
			{ id: 27, text: "Avion (Lens)", next: "QCo2" },
			{ id: 28, text: "Arras", next: "QCo2" },
			{ id: 29, text: "Amiens", next: "QCo2" },
			{ id: 30, text: "Paris Nord", next: "QCo2" },
			{ id: 99, text: "Autre", next: "QC2_A" }
		]
	},
	{
		id: "QC2_A",
